                            ...
                            buttons: {
                                ok: {
                                    ...
                                    callback: (form) => __awaiter(void 0, void 0, void 0, function* () {
                                        game.decks.create($(form).find('#file')[0]['files'][0], $(form).find('#deckImg')[0]['files'][0]);
                                    })
                                },
                                cancel: {
                            ...
                            buttons: {
                                import: {
                                    ...
                                    callback: (html) => __awaiter(void 0, void 0, void 0, function* () {
                                        game.decks.createByImages(html.find("#deckName")[0].value, html.find("#cardFiles")[0].files, html.find("#cardBack")[0].files[0], html.find("#deckImg")[0].files[0]);
                                    })
                                }
                            }
                        }).render(true);
